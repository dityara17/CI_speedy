    ...
    <div class="container">
        <nav class="top-nav">
            <ul>
                ...
                <li class="active"><a href="./category/1">TEACH DEALS</a></li>
                <li><a href="./category/6">GAME DEALS</a></li>
                <li><a href="./category/7">APPAREL DEALS</a></li>
                <li><a href="./category/8">GENERAL DEALS</a></li>
            </ul>
        </nav>
        <div class="title">
            <h2>TEACH DEALS</h2>
        ...
        <div class="category">
            <nav>
                <ul>
                    ...
                    <li><a href="./cat-sub/<?=$category['id_category']?>"><?=$category['c_name']?></a></li>
                    <?php endforeach; ?>
                </ul>
            </nav>
        </div>
